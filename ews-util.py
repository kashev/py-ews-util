...
def getJsonFromEWS(url):
    """ Given a URL to the EWS JSON API, gets the JSON object containing
        lab data.
    """
...
def getBarString(fraction, width=40):
    """Create a bar graph based on the input fraction and the width."""
...
def pprintLabData(data):
    """Given the JSON object to lab data, pretty prints it with nice bar
       graph utilization.
    """
    # Print Constants
    bar_width = 40
